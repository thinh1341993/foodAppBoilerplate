...
## The latest and greatest boilerplate for Dungnd opinions

This is the boilerplate that [Dungnd](https://solidtech.vn) uses as a way to test bleeding-edge changes to our React Native stack.
